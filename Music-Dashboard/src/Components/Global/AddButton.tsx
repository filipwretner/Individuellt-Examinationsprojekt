...
const AddButton: React.FC<AddButtonProps> = ({ song }) => {
    ...
    return (
        <button onClick={handleAdd} className="w-10 h-10 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full flex items-center justify-center flex-shrink-0">
            +
        </button>
    );
};
